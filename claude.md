...
## 14. InfoNCE 3rd fix1 GPU 실험 결과 (2026-03-04)

**실험 경로**: `faap_outputs/faap_outputs_infonce_3rd_fix1_gpu/`
**측정 조건**: epsilon=0.1, test split, batch_size=20

### 14.1 Epoch별 핵심 메트릭 (AP & AR @[0.50:0.95])

| Epoch | Male AP | Female AP | AP Gap | AP Gap Δ% | Male AR | Female AR | AR Gap | AR Gap Δ% |
|-------|---------|-----------|--------|-----------|---------|-----------|--------|-----------|
| Baseline | 0.511 | 0.404 | 0.107 | - | 0.834 | 0.826 | 0.008 | - |
| E0 | 0.513 | 0.413 | 0.100 | -6.0% | 0.835 | 0.835 | 0.001 | -91.4% |
| E1 | 0.516 | 0.413 | 0.104 | -2.5% | 0.837 | 0.832 | 0.004 | -45.7% |
| E2 | 0.517 | 0.414 | 0.103 | -3.3% | 0.836 | 0.832 | 0.004 | -53.1% |
| E3 | 0.521 | 0.415 | 0.106 | -0.8% | 0.838 | 0.834 | 0.005 | -40.7% |
| E4 | 0.520 | 0.409 | 0.111 | +4.4% | 0.839 | 0.834 | 0.005 | -43.2% |
| E5 | 0.519 | 0.414 | 0.106 | -0.7% | 0.840 | 0.832 | 0.008 | -1.2% |
| E6 | 0.518 | 0.414 | 0.104 | -2.1% | 0.836 | 0.831 | 0.006 | -30.9% |
| E7 | 0.515 | 0.407 | 0.107 | +1.0% | 0.836 | 0.830 | 0.006 | -23.5% |
| E8 | 0.518 | 0.408 | 0.110 | +3.6% | 0.839 | 0.832 | 0.007 | -12.3% |
| E9 | 0.519 | 0.411 | 0.108 | +1.9% | 0.840 | 0.831 | 0.008 | +3.7% |
| E10 | 0.514 | 0.406 | 0.108 | +1.5% | 0.837 | 0.830 | 0.007 | -11.1% |
| **7th (E23)** | **0.514** | **0.408** | **0.106** | **-0.4%** | **0.836** | **0.833** | **0.003** | **-60.5%** |

### 14.2 주요 후보 epoch 요약

| | Male AP | Female AP | AP Gap | AP Gap Δ% | Male AR | Female AR | AR Gap | AR Gap Δ% |
|---|---------|-----------|--------|-----------|---------|-----------|--------|-----------|
| **Baseline** | 0.511 | 0.404 | 0.107 | - | 0.834 | 0.826 | 0.008 | - |
| **7th (E23)** | 0.514 | 0.408 | 0.106 | -0.4% | 0.836 | 0.833 | 0.003 | -60.5% |
| **infonce_3rd_fix1_gpu E0** (Gap 최소) | 0.513 | 0.413 | **0.100** | **-6.0%** | 0.835 | 0.835 | **0.001** | **-91.4%** |
| **infonce_3rd_fix1_gpu E3** (성능 최고) | **0.521** | **0.415** | 0.106 | -0.8% | **0.838** | **0.834** | 0.005 | -40.7% |

### 14.3 분석 및 결론

1. **E0 (Gap 기준 최고)**: AR Gap -91.4%, AP Gap -6.0% — 공정성 지표 최고이나 초기 epoch으로 학습 불안정
2. **E3 (성능 기준 최고)**: Male AP +1.9%, Female AP +2.8% — 검출 성능 최고, AP Gap도 -0.8%로 준수
3. **학습 불안정 원인**: Small object AP 노이즈 (Female AP_small이 0.075~0.500 사이 진동)
4. **7th 대비**: AP 성능은 InfoNCE E3가 우위, AR Gap 안정성은 7th(-60.5%)가 우위
5. **전반적 평가**: InfoNCE는 초반(E0~E4)에는 공정성 개선 효과가 있으나 학습이 길어질수록 7th 수준으로 수렴 또는 퇴화

---

*최종 업데이트: 7th.py 기준 (논문 제출 버전)*
*SimCLR InfoNCE 버전 추가: train_faap_simclr_infonce.py*
*InfoNCE 3rd fix1 GPU 실험 결과 추가: 2026-03-05*
