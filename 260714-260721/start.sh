...
#     (B) 260714-260721_contrastive_l2_anchor.py       + γ·L2 anchor
#     (C) 260714-260721_contrastive_centroid_anchor.py + γ·centroid anchor
#
...
script_for() {
  case "$1" in
    base) echo "${SCRIPT_DIR}/260714-260721_contrastive_baseline.py" ;;
    l2)   echo "${SCRIPT_DIR}/260714-260721_contrastive_l2_anchor.py" ;;
    cent) echo "${SCRIPT_DIR}/260714-260721_contrastive_centroid_anchor.py" ;;
