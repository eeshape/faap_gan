...
def parse_args() -> argparse.Namespace:  # 커맨드라인 인자를 파싱해 Namespace로 반환
    ...
    parser.add_argument("--epochs", type=int, default=24)  # 학습 에폭 수
    ...
    parser.add_argument("--epsilon_hold_epochs", type=int, default=6, help="epochs to keep epsilon_final before cooldown")  # epsilon 유지 에폭
    parser.add_argument("--epsilon_cooldown_epochs", type=int, default=10, help="epochs to linearly cool epsilon")  # epsilon 감소 에폭
    parser.add_argument("--epsilon_min", type=float, default=0.09, help="minimum epsilon after cooldown")  # 쿨다운 후 최소 epsilon
    ...
    parser.add_argument("--beta_final", type=float, default=0.6, help="final detection-preserving loss weight")  # 검출 손실 최종 가중치
